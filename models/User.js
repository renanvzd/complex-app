...
User.prototype.validate = function() {
    ...
    //if(this.data.email == "") {this.errors.push("You must provide a valid email adress.")}
    ...
    if(this.data.password.length > 100) {this.errors.push("Password cannot exceed 100 charaters.")}
    if(this.data.username.length > 0 && this.data.username.length < 3) {this.errors.push("Username must be at least 12 characters.")}
    if(this.data.username.length > 30) {this.errors.push("Username cannot exceed 300 charaters.")}
